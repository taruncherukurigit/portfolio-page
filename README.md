...
[![Live](https://img.shields.io/badge/live-tarunc.com-E8A33D)](https://tarunc.com)
[![Pages mirror](https://img.shields.io/badge/mirror-GitHub%20Pages-5FD3D6)](https://taruncherukurigit.github.io/portfolio-page/)
![License: MIT](https://img.shields.io/badge/license-MIT-lightgrey)

**View live:** [tarunc.com](https://tarunc.com)
*(If the server's down or being updated: [GitHub Pages mirror](https://taruncherukurigit.github.io/portfolio-page/) or browse this repo.)*

Network engineer pursuing CCNA and CWNA, M.Eng in Cybersecurity (University of Maryland,
3.9 GPA). This site is the front door to three flagship projects, all built end to end on
real enterprise hardware rather than a simulator.
...
```
index.html    The full site — experience, education, certifications, all three
