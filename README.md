...
Network engineer pursuing CCNA and CWNA, M.Eng in Cybersecurity (University of Maryland, 3.9 GPA). This site is the front door to five projects, all built end to end on real enterprise hardware rather than a simulator.
